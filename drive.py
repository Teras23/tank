...
class Motor():
    ...
    def Drive(self, left, right):
        ...
        try:
            self.left.ChangeDutyCycle(self.pwm1bal+left*100/8+right*100/8) #Parempoolne mootor kiiruse seadistamine vastavalt nutiseadme x ja y vaartustele
            self.right.ChangeDutyCycle(self.pwm2bal-left*100/8+right*100/8) #Vasakpoolne mootor kiiruse seadistamine vastavalt nutiseadme x ja y vaartustele
